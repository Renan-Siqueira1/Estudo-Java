...
<c:url value="/NovoClient" var="cadastroClienteUrl"></c:url>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="${cadastroClienteUrl }" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user"
                                            id="numberCard" name="cartao" placeholder="Número do cartão">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user"
                                            id="password" name="senha" placeholder="Senha">
                                    </div>
                                </div>
